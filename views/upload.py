...
def upload_index():
    if request.method == "POST":
        try:
            ...
            # 2) Leer todo como texto y rellenar con ""
            ...
            # 6) Rellenar nombre/barrio/ciudad faltantes por cliente usando transform
            ...
            # NOTA: codigo_pro queda como texto
            ...
            # 10) Obtener resumen y crear Excel
            conn = conectar(); cur = conn.cursor()
