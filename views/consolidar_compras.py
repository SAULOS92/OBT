...
ECOM_COLUMN_SPEC = {
    ...
    "Cantidad_del_pedido":     {"type":"agg",    "source":"Cantidad del pedido"},
    "Unidad_de_medida":        {"type":"agg",    "source":"Unidad de medida"},
    "Valor_pedido":            {"type":"static", "static_value":"0"},
    "Vendedor":                {"type":"static", "static_value":"0"},
    "Codigo_sap_cliente":      {"type":"agg",    "source":"Codigo Sap Cliente"},
    "Nombre_cliente":          {"type":"static", "static_value":"0"},
    "Factura_sap":             {"type":"static", "static_value":"0"},
    "Fecha_factura":           {"type":"agg",    "source":"Fecha Factura"},
    ...
    "Iva_valor":               {"type":"agg",    "source":"Iva_valor"},
